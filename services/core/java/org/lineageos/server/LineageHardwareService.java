    ...
    public void onBootPhase(int phase) {
        if (phase == PHASE_BOOT_COMPLETED) {
            ...
            mContext.sendBroadcastAsUser(intent, UserHandle.ALL,
                    android.Manifest.permission.HARDWARE_ABSTRACTION_ACCESS);
        }
    }
    ...
    private final IBinder mService = new ILineageHardwareService.Stub() {
        ...
        public int getSupportedFeatures() {
            mContext.enforceCallingOrSelfPermission(
                    android.Manifest.permission.HARDWARE_ABSTRACTION_ACCESS, null);
        ...
        public boolean writePersistentBytes(String key, byte[] value) {
            mContext.enforceCallingOrSelfPermission(
                    android.Manifest.permission.MANAGE_PERSISTENT_STORAGE, null);
