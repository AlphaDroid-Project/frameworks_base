...
import static com.android.internal.lineage.content.Intent.ACTION_INITIALIZE_LIVEDISPLAY;
...
public class LiveDisplayService extends SystemService {
    ...
    public void onBootPhase(int phase) {
        if (phase == PHASE_BOOT_COMPLETED) {
            ...
            Intent intent = new Intent(ACTION_INITIALIZE_LIVEDISPLAY);
    ...
    private final IBinder mBinder = new ILiveDisplayService.Stub() {
        ...
        public boolean setMode(int mode) {
            mContext.enforceCallingOrSelfPermission(
                    android.Manifest.permission.MANAGE_LIVEDISPLAY, null);
            if (!mConfig.hasModeSupport()) {
                return false;
            }
