...
public class SleepModeService extends SystemService {
    ...
    private final SleepModeHelper mSleepModeHelper;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (Settings.Secure.SLEEP_MODE_ENABLED.equals(uri)) {
                mHandler.post(() -> updateSleepMode());
            }
            else {
              mHandler.post(() -> updateAutoMode());
            }
        }
    }
    ...
    public SleepModeService(Context context) {
        ...
        mSleepModeHelper = new SleepModeHelper(context);
    }
    ...
    private void updateSleepMode() {
        ...
        if (mSleepModeEnabled != enabled) {
            ...
            mSleepModeHelper.setSleepModeState(mContext, enabled);
        }
    }
