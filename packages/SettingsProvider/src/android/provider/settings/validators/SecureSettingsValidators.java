...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.LOCKSCREEN_SMARTSPACE_SOURCE,
                new InclusiveIntegerRangeValidator(
                        Secure.LOCKSCREEN_SMARTSPACE_SOURCE_AXION,
                        Secure.LOCKSCREEN_SMARTSPACE_SOURCE_NONE));
        ...
        VALIDATORS.put(Secure.QS_PANEL_BLUR_INTENSITY, PERCENTAGE_INTEGER_VALIDATOR);
