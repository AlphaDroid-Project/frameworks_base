...
open class LandscapeBatteryDrawableiOS16A(private val context: Context, frameColor: Int) : Drawable() {
    ...
    private var backgroundColor: Int = 0xFFF0F0F0.toInt()

    // updated whenever level changes
    private var levelColor: Int = 0xFFF0F0F0.toInt()
    ...
    private fun batteryColorForLevel(level: Int): Int {
        return when {
            charging -> 0xFF008000.toInt()
            powerSaveEnabled -> 0xFFFFCC0A.toInt()
            level > Companion.CRITICAL_LEVEL -> 0xFF90EE90.toInt()
    ...
    fillColorStrokePaint.color = 0xFF000000.toInt() // Black for the frame
    ...
    companion object {
        private const val TAG = "LandscapeBatteryDrawableiOS16A"
